    ...
    <div class="row">
    	...
    	<div class="col-sm-9">
            <ul class="nav nav-tabs">
                ...
                <li><a data-toggle="tab" href="#settings">Interests</a></li>
              </ul>
                  ...
                  <form class="form" action="##" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-12">
                              ...
                              <input type="password" class="form-control" name="password" id="password" placeholder="password" title="enter your new password">
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-xs-12">
                            <label for="verify"><h4>Verify Password</h4></label>
                              <input type="password" class="form-control" name="verify" id="verify" placeholder="Verify Password" title="enter your new password again">
                          </div>
                      </div>
                      <div class="form-group">
                           <div class="col-xs-12">
